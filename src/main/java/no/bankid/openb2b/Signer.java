...
public class Signer {
    ...
    public static byte[] signWithoutOCSPResponse(byte[] dataToBeSigned,
        ...
        try {
            ...
            SignerInfo signerInfo = createSignerInfo(signerCertificate, new DEROctetString(doDigest(dataToBeSigned)), signerKey);
            ...
            for (X509CertificateHolder c : toCertificateHolder(signerCertPath.getCertificates())) {
    ...
    private static SignerInfo createSignerInfo(X509CertificateHolder signerCertificate, ASN1OctetString dtbsDigest, PrivateKey privateKey)
        ...
        IssuerAndSerialNumber signerId = new IssuerAndSerialNumber(signerCertificate.getIssuer(), signerCertificate.getSerialNumber());
    ...
    private static byte[] signData(PrivateKey privateKey, byte[] toBeSigned) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
