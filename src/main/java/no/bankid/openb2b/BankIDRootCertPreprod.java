...
public class BankIDRootCertPreprod {

    private static final String BANKID_ROOT_CERTIFICATE_PREPROD =
            "-----BEGIN CERTIFICATE-----\n"
    ...
    static InputStream getInputStream() {
        return new ByteArrayInputStream(BANKID_ROOT_CERTIFICATE_PREPROD.getBytes());
    }
}
